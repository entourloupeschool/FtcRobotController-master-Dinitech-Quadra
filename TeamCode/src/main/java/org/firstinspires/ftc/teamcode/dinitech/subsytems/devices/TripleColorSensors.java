...
public class TripleColorSensors {
    ...
    public static float GAIN_DETECTION = 8;
    public static final int SAMPLE_SIZE_TEST = 2;

    public static double DETECT_PURPLE_RED_RGB = 0.694;
    public static double DETECT_PURPLE_GREEN_RGB = 0.612;
    public static double DETECT_PURPLE_BLUE_RGB = 0.851;
    public static double MARGIN_PURPLE_RGB_DETECTION = 0.25;

    public static double DETECT_GREEN_RED_RGB = 0.2;
    public static double DETECT_GREEN_GREEN_RGB = 0.9;
    public static double DETECT_GREEN_BLUE_RGB = 0.2;
    public static double MARGIN_GREEN_RGB_DETECTION = 0.35;
