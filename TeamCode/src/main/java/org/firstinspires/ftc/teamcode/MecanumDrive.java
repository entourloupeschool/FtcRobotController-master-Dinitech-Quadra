...
public final class MecanumDrive {
    public static class Params {
        ...
        public double trackWidthTicks = 1068079.4848455412;// 1035974.7139795484; // (1045403.815333148 + 1034082.0695325453 +
                                          // 1038872.9470135397)/3; // = 1039452,944

        // feedforward parameters (in tick units)
        public double kS = 1.408;// 1.3908; //(1.4099651326853069 + 1.3835639598407194 +
                                              // 1.3927853890607231)/3; // = 1.3954384905282498
        public double kV = 0.00009379;// 0.0000932; //(0.00009512865913039126 + 0.00009573321459611875 +
                                                  // 0.00009544338567487954)/3; // = 0.00009543541980046385
        public double kA = 0.00002;// 0.000015; //0.000011;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        // localizer = new AprilTagLocalizer(new PinpointLocalizer(hardwareMap,
        // PARAMS.inPerTick, pose), visionSubsystem.aprilTagProcessor);
