        ...
        addCommands(
                new ParallelCommandGroup(
                        new SequentialCommandGroup(
                                new InstantCommand(),
                                new SetVelocityShooterRequire(shooterSubsystem, ShootPosition.getY() > 72 ? CLOSE_SHOOT_AUTO_SHOOTER_VELOCITY : SMALL_TRIANGLE_AUTO_SHOOTER_VELOCITY)),
    ...
    public InitToShoot(DrivePedroSubsystem drivePedroSubsystem, TrieurSubsystem trieurSubsystem, ShooterSubsystem shooterSubsystem, HubsSubsystem hubsSubsystem){
        addCommands(
                new ParallelCommandGroup(
                        new SequentialCommandGroup(
                                new InstantCommand(),
                                new SetVelocityShooterRequire(shooterSubsystem, drivePedroSubsystem.getPose().getY() > 72 ? CLOSE_SHOOT_AUTO_SHOOTER_VELOCITY : SMALL_TRIANGLE_AUTO_SHOOTER_VELOCITY)),
