...
public class GornetixAutoBlueSmallTriangle extends DinitechRobotBase {
    ...
    public void initialize() {
            ...
            new SequentialCommandGroup(
                    ...
                    new InitToMotifShoot(drivePedroSubsystem, trieurSubsystem, shooterSubsystem, chargeurSubsystem, visionSubsystem, gamepadSubsystem, BLUE_SMALL_TRIANGLE_POSE, BLUE_SMALL_TRIANGLE_SHOOT_POSE, SMALL_TRIANGLE_AUTO_SHOOTER_VELOCITY),

                    new ShootTimeAuto(trieurSubsystem, chargeurSubsystem),

                    new ShootToRowToMotifShoot(drivePedroSubsystem, trieurSubsystem, shooterSubsystem, chargeurSubsystem, visionSubsystem, gamepadSubsystem, BLUE_SMALL_TRIANGLE_SHOOT_POSE, THIRD_ROW_BLUE_POSE, SMALL_TRIANGLE_AUTO_SHOOTER_VELOCITY),

                    new ShootTimeAuto(trieurSubsystem, chargeurSubsystem),

                    new ShootToRowToMotifShoot(drivePedroSubsystem, trieurSubsystem, shooterSubsystem, chargeurSubsystem, visionSubsystem, gamepadSubsystem, BLUE_SMALL_TRIANGLE_SHOOT_POSE, SECOND_ROW_BLUE_POSE, CLOSE_SHOOT_BLUE_POSE, CLOSE_SHOOT_AUTO_SHOOTER_VELOCITY),

                    new ShootTimeAuto(trieurSubsystem, chargeurSubsystem),

                    new ShootToRowToMotifShoot(drivePedroSubsystem, trieurSubsystem, shooterSubsystem, chargeurSubsystem, visionSubsystem, gamepadSubsystem, CLOSE_SHOOT_BLUE_POSE, FIRST_ROW_BLUE_POSE, CLOSE_SHOOT_AUTO_SHOOTER_VELOCITY),
