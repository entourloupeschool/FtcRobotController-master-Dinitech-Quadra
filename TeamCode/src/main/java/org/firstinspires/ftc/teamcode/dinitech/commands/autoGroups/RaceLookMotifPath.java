...
public class LookMotifPath extends SequentialCommandGroup {
    ...
    public LookMotifPath(DrivePedroSubsystem drivePedroSubsystem, VisionSubsystem visionSubsystem, Pose lookMotifPose, double scaleBrakingStrength, double endTime){
        addCommands(
    ...
    public LookMotifPath(DrivePedroSubsystem drivePedroSubsystem, VisionSubsystem visionSubsystem, Pose lookMotifPose){
        addCommands(
                new ParallelRaceGroup(
                        new FollowPath(drivePedroSubsystem, builder -> builder
                                .addPath(new BezierLine(
