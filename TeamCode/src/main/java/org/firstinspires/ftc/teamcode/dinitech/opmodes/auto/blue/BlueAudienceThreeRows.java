...
public class BlueAudienceThreeRows extends BlueAudienceAutoBase {
    ...
    public void initialize() {
            ...
            new BlueThreeRowsFromAudience(drivePedroSubsystem, trieurSubsystem, shooterSubsystem, visionSubsystem, chargeurSubsystem, gamepadSubsystem, AUTO_ROBOT_CONSTRAINTS).schedule();
    }
