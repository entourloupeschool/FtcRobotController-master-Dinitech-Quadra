 ...
 * </pre>
 */
public class LineTangentHeadingToTarget extends FollowPath {
     ...
     */
    public LineTangentHeadingToTarget(DrivePedroSubsystem drivePedroSubsystem, Pose targetPose, double maxPower, boolean holdEnd) {
        super(drivePedroSubsystem, createDefaultBezierLineToTargetPoseTangentHeadingSupplier(drivePedroSubsystem, targetPose), maxPower, holdEnd);
    }


    private static PathSupplier createDefaultBezierLineToTargetPoseTangentHeadingSupplier(DrivePedroSubsystem drivePedroSubsystem, Pose targetPose) {
