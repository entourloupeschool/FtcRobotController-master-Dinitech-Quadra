...
public class RamassageAuto extends SequentialCommandGroup {
    ...
    public RamassageAuto(TrieurSubsystem trieurSubsystem, VisionSubsystem visionSubsystem,
        ...
        addCommands(buildRamassageAutoPrefix(trieurSubsystem, chargeurSubsystem, gamepadSubsystem));
    ...
    public RamassageAuto(TrieurSubsystem trieurSubsystem, VisionSubsystem visionSubsystem,
        ...
        addCommands(buildRamassageAutoPrefix(trieurSubsystem, chargeurSubsystem));
        addCommands(new ParallelCommandGroup(
    ...
    private static Command[] buildRamassageAutoPrefix(TrieurSubsystem trieurSubsystem, ChargeurSubsystem chargeurSubsystem) {
        return new Command[]{
                BeginRamassageAuto(trieurSubsystem, chargeurSubsystem),
                new TryDetectArtefactOptimized(trieurSubsystem),
                ConditionalRegister(trieurSubsystem),
                ConditionalRegister(trieurSubsystem)
        };
    }

    private static Command[] buildRamassageAutoPrefix(TrieurSubsystem trieurSubsystem,
                                                       ChargeurSubsystem chargeurSubsystem,
                                                       GamepadSubsystem gamepadSubsystem) {
        return new Command[]{
                BeginRamassageAuto(trieurSubsystem, chargeurSubsystem),
                new TryDetectArtefactOptimizedRumble(trieurSubsystem, gamepadSubsystem),
                ConditionalRegister(trieurSubsystem, gamepadSubsystem),
                ConditionalRegister(trieurSubsystem, gamepadSubsystem)
        };
    }
    ...
    public static ConditionalCommand ConditionalRegister(TrieurSubsystem trieurSubsystem){
    ...
    public static ConditionalCommand ConditionalRegister(TrieurSubsystem trieurSubsystem, GamepadSubsystem gamepadSubsystem){
        return new ConditionalCommand(
                new SequentialCommandGroup(
                        new MoulinNextEmptyStorage(trieurSubsystem),
                        new TryDetectArtefactOptimizedRumble(trieurSubsystem, gamepadSubsystem)),
