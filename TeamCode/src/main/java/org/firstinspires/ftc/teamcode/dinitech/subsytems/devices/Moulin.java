...
public class Moulin {
    ...
    public static int WAIT_HIGH_SPEED_TRIEUR = 80; //400;
    ...
    public static double P_MOULIN_ENCODER = 0.000395;
    public static double I_MOULIN_ENCODER = 0.0115;
    public static double D_MOULIN_ENCODER = 0.000012;
...
//        // https://docs.google.com/document/d/1tyWrXDfMidwYyP_5H4mZyVgaEswhOC35gvdmP-V-5hA/mobilebasic
    ...
    public void moulinPeriodicLogic(){
        setPower(getPIDFRun(getMotorPosition()));
    }
